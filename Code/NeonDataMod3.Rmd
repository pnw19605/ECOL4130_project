...
```
#Figure 1 cpation:This scatterplot shows the combined data for both years 2018-2019. There is a slightly negative correlation between mosquito abundance and chlorophyll-a concentration. When chlorophyll-a increases, mosquito abundance tends to decrease.
